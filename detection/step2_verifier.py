...
produced by :class:`step1_detector.Step1Detector`.  It inspects a short
...
This module provides :class:`Step2Verifier`, a thin wrapper that loads
...
class Step2Verifier:
    ...
    def __init__(self, model_path: str, threshold: float = 0.7) -> None:
        ...
        self.model = None
        if model_path:
            LOGGER.info("Step2Verifier initialised with model %s", model_path)
